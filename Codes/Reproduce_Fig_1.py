...
@author: Loic Viens
Simplified version of the maps (Figure 1)
...
# Loop over the 4 lines to plot the stations
for lnb in (np.arange(4)+1):
    if lnb ==1:
        ...
        station = ['E.DSCM','E.NBKM','E.SSSM','E.AZMM','E.KNZM','E.NSKM','E.NSOM','E.SECM','E.FKMM','E.OMSM','E.SSPM','E.SR2M', 'E.NNTM', 'E.STHM','E.TYNM', 'E.KRCM', 'E.KSCM','E.MDHM','E.OYTM','E.HKBM','E.MKJM','E.KSGM','E.YYIM', 'E.KHDM','E.TYPM', 'E.NSJM', 'E.MSOM', 'E.UNHM', 'E.CF3M','E.KYDM','E.KTOM', 'E.BTSM','E.OYOM','OK.NHMM', 'OK.NKYM', 'OK.TKCM', 'OK.AONM','OK.AOCM', 'E.KBAM', 'E.RYNM', 'E.KCBM','E.MZMM' ,'E.SIBM']
        col = 'green'
        postext = [139, 35.43]
    elif lnb ==4:
...
center_lat = 35.75
center_lon = 140
map = Basemap(projection='aeqd', lat_0 = center_lat,lon_0 = center_lon, resolution='l')
map.shadedrelief(scale = 0.1)
map.drawcoastlines(linewidth = 0.25)
plt.annotate('(b)', xy = (0, .95), xycoords = 'axes fraction', fontsize=14)

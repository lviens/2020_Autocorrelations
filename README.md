...
- Viens L., C. Jiang, and M. Denolle (re-submitted), Imaging the Kanto Basin bedrock with earthquake and noise autocorrelation functions
...
* The **Codes** folder contains:
  ...
  - **Reproduce_Fig_3.py** to reproduce Figure 4 of the paper (Maps of the Kanto Basin basin depth).
